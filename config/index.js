...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx950c9f740967f3d9',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'a2e6b9e6c69f4a18cb1dc95c894e666c',
  ...
  USERS: [
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '宝贝', year: '2001', date: '07-23',
        },
        {
          type: '节日', name: '在一起的日子', year: '2022', date: '09-10',
        },
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {
          type: '生日', name: '宝贝', year: '2001', date: '09-10',
        },
        {
          type: '节日', name: '认识的日子', year: '2022', date: '05-01',
        }
      ],
